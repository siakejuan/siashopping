...
<body style="font-family: Arial; font-size: 20px;">
	<div
		...
		<br> <b> <a href=""
			style="font-family: garamond; font-size: 34px; margin: 0px 0px 0px 10px; color: white; text-decoration: none;">MERDEKA SHOPPING</a></b>
		<div
	...
	<table>
		<c:forEach var="book" items="${books}">
			<tr>
				<td><img src="${book.imageUrl}" width="175" height="200"></td>
